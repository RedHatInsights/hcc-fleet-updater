...
import (
	...
	"github.com/RedHatInsights/hcc-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(hccv1alpha1.AddToScheme(scheme))
	utilruntime.Must(clowdapp.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "050dddd5.hcc.redhat.com",
	...
	if err := (&controller.HCCAppConfigurationReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "HCCAppConfiguration")
		os.Exit(1)
	}
